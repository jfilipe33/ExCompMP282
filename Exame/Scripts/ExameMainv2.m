...
pc.K3 = diag([0.075 0.075 3]);
pc.K4 = diag([2.15 2.15 1.35]);
...
pc.acc = [0 0 0]'; %3D initial accleration
...
for cont = 1:tf/Ts
    ...
    pc.aTar = (pc.vTar - pc.vTarprev)/mavsim.Ts;
    pc.Fc = mav.m*(pc.K3*(pc.rTar-pc.r) + pc.K4*(pc.vTar-pc.v) + 0.1*pc.aTar + mav.g*mav.e3);
